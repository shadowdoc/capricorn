...
CREATE TABLE IF NOT EXISTS `ExamCodeDefinition` (
  ...
  `CPT_Code_1` varchar(10),
  `CPT_Code_2` varchar(10),
  `CPT_Code_3` varchar(10),
  `RVU_Modifier` varchar(5),
  `CPT_Desc_1` varchar(35),
  `CPT_Desc_2` varchar(35),
  `CPT_Desc_3` varchar(35),
  `RVU_CPT_1` decimal(8,3) NOT NULL DEFAULT 0,
  `RVU_CPT_2` decimal(8,3) NOT NULL DEFAULT 0,
  `RVU_CPT_3` decimal(8,3) NOT NULL DEFAULT 0,
  `TOTAL_RVU` decimal(8,3) NOT NULL DEFAULT 0,
